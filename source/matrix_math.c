void screen_proj_mat(float left, float right, float top, float bottom, float far, const float *eye, float *mat) {
  ...
  // This is basically an implementation of the multiplication of a translation matrix and matrix generated by glFrustrum from OpenGL 1.0. See https://www.opengl.org/sdk/docs/man2/xhtml/glFrustum.xml
