...
*/
#define BOX_SIZE 4.0
#define BOX_SIZE_Z_OFFSET -1
GLfloat boxVerticies[8][3] =
{
  {-BOX_SIZE,-BOX_SIZE,BOX_SIZE_Z_OFFSET},{BOX_SIZE,-BOX_SIZE,BOX_SIZE_Z_OFFSET},
  {BOX_SIZE,BOX_SIZE,BOX_SIZE_Z_OFFSET},{-BOX_SIZE,BOX_SIZE,BOX_SIZE_Z_OFFSET},

  {-BOX_SIZE,-BOX_SIZE,-BOX_SIZE + BOX_SIZE_Z_OFFSET},{BOX_SIZE,-BOX_SIZE,-BOX_SIZE + BOX_SIZE_Z_OFFSET},
  {BOX_SIZE,BOX_SIZE,-BOX_SIZE + BOX_SIZE_Z_OFFSET},{-BOX_SIZE,BOX_SIZE,-BOX_SIZE + BOX_SIZE_Z_OFFSET},
};
